...
function formEmail(){
  ...
  if(honey == ""){
    window.location.href = "mailto:jens_nickelsen@live.com?subject=New Clan Application&body=" + name +"%0D%0A" + birthday +"%0D%0A" + age +"%0D%0A" + city +"%0D%0A" + email +"%0D%0A" + country +"%0D%0A" + about;
}
else{
